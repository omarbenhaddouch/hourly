...
# 🖼️ End-of-Shift Report & Screenshot Function
...
<img width="2358" height="5112" alt="Hourly Production Monitoring application including the Report button" src="https://github.com/user-attachments/assets/803c5d32-28b2-4dca-9e5c-588227f058a6" />
...
### 🎨 Automatic Performance Colors in the Report

The generated report keeps the production performance easy to understand visually:

- 🟢 **Green** — Target achieved or exceeded
- 🟡 **Yellow / Amber** — Production is close to the target
- 🔴 **Red** — Production is below the expected level

### 📱 Sharing and Saving

The application automatically chooses the best option supported by the device:

- **Mobile:** Opens the system share sheet when file sharing is supported.
- **Desktop:** Opens a save dialog when supported.
- **Fallback:** Automatically downloads the report as a `.png` file.
